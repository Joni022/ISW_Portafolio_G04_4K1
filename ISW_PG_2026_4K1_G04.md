...
| DEV   | Devolución                       |
| T     | Template                         |
| PM    | Presentación de Materia          |
| LPTI  | Lineamientos Para Trabajos de investigación    |
| HPPI  | Herramientas Para Presentación De Información  |
| GTPR  | Guía de Trabajos Prácticos Resueltos |
...
| **Guía de Trabajos Prácticos Resueltos** | `ISW_GTPR.pdf` | `Material_Practico/` | De cátedra |
| **Templates**                                   | `ISW_T_<Nombre>.docx / .xlsx`                                | `Material_Practico/Templates`                                             | De cátedra
...
| **Herramientas Para Presentación De Información** | `ISW_HPPI.pdf` | `Material_Teorico/` | De cátedra |
| **Lineamientos Para Trabajos de Investigación** | `ISW_LPTI.pdf` | `Entregas/Investigaciones/` | De cátedra |
| **Listado de temas de parcial** | `ISW_PR_ListadoDeTemasDelParcial_<Nro>.pdf` | `Material_Practico/Parcial_<Nro>/` | De cátedra |
